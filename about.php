...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/img2.jpeg');" data-stellar-background-ratio="0.5">
		...
		<section class="ftco-section ftco-wrap-about ftco-no-pb ftco-no-pt">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-sm-5 img img-2 d-flex align-items-center justify-content-center justify-content-md-end" style="background-image: url(images/IMG_20190822_142706_537.jpg); position: relative">
            <a href="video/cake.mp4" class="icon-video popup-vimeo d-flex justify-content-center align-items-center"><!-- <video src="video/cake.mp4" poster="images/puppy.jpg" width="400" height="300" preload controls loop>
	          ...
	          <div class="heading-section mt-5 mb-4">
	          	<div class="pl-lg-5 ml-md-5">
		            ...
		            <h2 class="mb-4">Welcome to Whytecholcola8 Cakes</h2>
	            </div>
	          </div>
	          <div class="pl-lg-5 ml-md-5">
      ...
      <div class="container">
		...
		<section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <p><a href="Order.php" class="btn btn-primary px-4 py-3" style="margin-right: 50px;">Place an order</a> <a href="FAQ.php" class="btn btn-primary px-4 py-3">Frequently Asked Questions</a></p>
          </div>
        </div>
			</div>
		</section>
